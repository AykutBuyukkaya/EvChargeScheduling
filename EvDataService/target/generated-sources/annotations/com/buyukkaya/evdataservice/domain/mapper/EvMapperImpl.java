...
public class EvMapperImpl implements EvMapper {
    ...
    public EvDto toDto(Ev ev) {
        ...
        BasicDBObject basicDBObject2 = ev.getEnergyConsumption();
        if ( basicDBObject2 != null ) {
            evDto.energyConsumption( new BasicDBObject( basicDBObject2 ) );
        }
